...
function daoAddressToTransfer(daoHackAddress) {
  ...
  return {
    from: address,
    to: DAO_REFUND_CONTRACT,
    value: balanceFloat,
    valueExactBase36: web3.utils.toBN('0x'+balance).toString(36),
    blockNumber: DAO_HACK_FORK_BLOCK,
